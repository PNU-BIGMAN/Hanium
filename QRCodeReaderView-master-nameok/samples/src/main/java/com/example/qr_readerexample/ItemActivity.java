...
public class ItemActivity extends Activity {
    ...
    public void ItemToHomepage(View view)
    {
    ...
    public String getJsonText() {
        ...
        try{
            String line  = getStringFromUrl("http://14.63.215.207:3000/search/remain");
            ...
            for (int i = 0; i < Array.length(); i++) {
                ...
                sb.append("material_nm : ").append(insideObject.getString("material_nm")).append("  ");
                sb.append("total_qty : ").append(insideObject.getString("total_qty")).append("  ");
